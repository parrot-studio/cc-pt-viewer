...
export default class EditHelpModal extends React.Component<EditHelpModalProps> {
      ...
      >
        <Modal.Body>
          ...
          <div className="embed-responsive embed-responsive-16by9">
            <iframe className="embed-responsive-item" src="//www.youtube.com/embed/j5NG-3cTlPs" />
          </div>
          <h3>パーティー編成方法</h3>
          <ol className="help">
